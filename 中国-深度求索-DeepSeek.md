...
### DeepSeek-R1
深度推理模型，对标OpenAI o1。采用强化学习训练，具备链式思维推理能力。在数学（AIME 2024得分79.8%，MATH-500得分97.3%）、编程（Codeforces评分2029）等任务上达到或超越o1水平。R1-Zero版本完全通过强化学习训练（无监督微调），展示了纯RL训练推理能力的可行性。V3通过从R1系列模型蒸馏知识来增强推理能力。
